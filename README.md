...
* RestCat along with a useEffect hook : a function that initialises a new Cat Connection and websocket stabilization.
...
In order to make the above functionality working we implemented a funcction msgTokenAdd(msg), where msg is a token.
